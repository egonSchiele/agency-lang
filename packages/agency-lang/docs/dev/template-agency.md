...
| `tests/agency/templates/` | Eleven execution fixtures: AG8001 + AG8002 (`expectedCompileError`), checkpoint survival (file and literal built), end-to-end injection, parent-handler governance, compose-then-parameterize (file and literal), `holesOf` origin, `${}` passthrough, malformed-literal compile error, no-imports registration |
