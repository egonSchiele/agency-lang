...
if (isInterrupt(__stack.locals.url)) {
  ...
  if (__ctx._skipNextCheckpoint) {
    ...
    const __cpId = __ctx.checkpoints.create(__ctx, { moduleId: "objectDescription.agency", scopeName: "main", stepPath: "2" });
...
export const __sourceMap = {"objectDescription.agency:main":{"1":{"line":-1,"col":2},"3":{"line":1,"col":2}}};