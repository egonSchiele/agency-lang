...
await print(__stack.args.prefix, ...__stack.args.messages)
    ...
    return failure(__error instanceof Error ? __error.message : String(__error), { checkpoint: __ctx.checkpoints.get(__resultCheckpointId), retryable: __self.__retryable, functionName: "log", args: __stack.args });
  } finally {
