...
async function __initializeGlobals(__ctx) {
  if (__ctx.globals.isInitialized("utilityTypes.agency")) {
    return;
  }
  __ctx.globals.markInitialized("utilityTypes.agency")
}
__registerGlobalsInit("utilityTypes.agency", __initializeGlobals);
async function __registerTopLevelCallbacks(__ctx) {

}
__registerCallbacksInit("utilityTypes.agency", __registerTopLevelCallbacks);
__functionRefReviver.registry = __toolRegistry;
const User = z.object({ "name": z.string(), "age": z.union([z.number(), z.null()]).optional().default(null) });
type User = z.infer<typeof User>;
const UserPatch = z.object({ "name": z.union([z.string(), z.null()]).optional().default(null), "age": z.union([z.number(), z.null()]).optional().default(null) });
type UserPatch = z.infer<typeof UserPatch>;
const Contact = z.object({ "name": z.string() });
type Contact = z.infer<typeof Contact>;
async function __patch_impl(changes: Partial<User>) {
...
let __functionCompleted = false;
  claimFrameForScope(__stack, "patch", "utilityTypes.agency");
  if (!__globals()!.isInitialized("utilityTypes.agency")) {
    await __initializeGlobals(__ctx)
  }
  let __funcStartTime: number = performance.now();
  __stack.args["changes"] = changes;
  __self.__destructiveRan = __self.__destructiveRan ?? false;
  const runner = new Runner(__ctx, __stack, { state: __stack, moduleId: "utilityTypes.agency", scopeName: "patch", threads: __setupData.threads });
...
if (__error instanceof AgencyAbort) {
  ...
  return AbortedResult.fromError(__error, __stack, "patch");
}
...
export const patch = __AgencyFunction.create({
  name: "patch",
  module: "utilityTypes.agency",
  fn: __patch_impl,
  params: [{
    name: "changes",
    hasDefault: false,
...
let __forked;
let __functionCompleted = false;
  claimFrameForScope(__stack, "main", "utilityTypes.agency");
...
runner.halt({
          messages: __threads(),
          data: await __call(patch, {
            type: "positional",
            args: [__stack.locals.changes]
          })
        })
return;
      });
...
graph.node("llmPatch", async (__state: GraphState) => {
  const __setupData = setupNode({
    state: __state
  });
  const __stack = __setupData.stack;
...
let __forked;
let __functionCompleted = false;
  claimFrameForScope(__stack, "llmPatch", "utilityTypes.agency");
...
__stack.locals.suggested = await runPrompt({
          prompt: `Suggest a partial user update`,
          messages: __threads().getOrCreateActive(),
          responseFormat: z.object({
            response: z.object({ "name": z.union([z.string(), z.null()]).optional().default(null), "age": z.union([z.number(), z.null()]).optional().default(null) })
          }),
          clientConfig: {},
...
await callHook({
    ...
    }
    {
              ...
              const __errStack = __error instanceof Error && __error.stack ? __error.stack : "";
              const __log = __createLogger(__ctx.logLevel);
              __log.error(`Node llmPatch crashed: ${__errMsg}`);
              if (__errStack) __log.error(__errStack);
              __ctx.statelogClient?.error?.({
                errorType: "runtimeError",
                message: __errMsg,
                functionName: "llmPatch",
              });
            }
    return {
      messages: __threads(),
      data: failure(__error instanceof Error ? __error.message : String(__error), { functionName: "llmPatch" })
    };
  }
})
...
export const __llmPatchNodeParams = [];
...
export const __sourceMap = {"utilityTypes.agency:patch":{"1":{"line":10,"col":2}},"utilityTypes.agency:main":{"1":{"line":14,"col":2},"2":{"line":15,"col":2},"3":{"line":16,"col":2}},"utilityTypes.agency:llmPatch":{"1":{"line":20,"col":2},"2":{"line":21,"col":2}}};