...
if (isInterrupt(__stack.locals.count)) {
  ...
  if (__ctx._skipNextCheckpoint) {
    ...
    const __cpId = __ctx.checkpoints.create(__ctx, { moduleId: "typeHints.agency", scopeName: "main", stepPath: "2" });
...
if (isInterrupt(__stack.locals.message)) {
  ...
  if (__ctx._skipNextCheckpoint) {
    ...
    const __cpId = __ctx.checkpoints.create(__ctx, { moduleId: "typeHints.agency", scopeName: "main", stepPath: "4" });
    const __cp = __ctx.checkpoints.get(__cpId);
    await callHook({
      callbacks: __ctx.callbacks,
      name: "onCheckpoint",
...
export const __sourceMap = {"typeHints.agency:main":{"1":{"line":2,"col":0},"3":{"line":5,"col":0},"5":{"line":7,"col":2},"6":{"line":8,"col":2}}};