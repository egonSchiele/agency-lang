...
export type Test = {
  ...
  graders?: string;
  /** Discovered agency-test harness pairs (files/*.test.json visible +
   *  holdout/*.test.json hidden). Set by directory-convention discovery,
   *  never by suite JSON directly; absolute paths. */
