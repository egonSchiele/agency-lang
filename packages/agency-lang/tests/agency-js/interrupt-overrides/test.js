...
const resumed3 = await resolveInterrupt(r3.data, "resolved-value", { overrides: { x: 77 } });
// Test 4: override LLM result before interrupt
const r4 = await testLlmOverride("I feel terrible");
const resumed4 = await approveInterrupt(r4.data, { overrides: { mood: "happy" } });

// Test 5: override inside a thread
const r5 = await testThread("I feel terrible");
const resumed5 = await approveInterrupt(r5.data, { overrides: { mood: "happy" } });
