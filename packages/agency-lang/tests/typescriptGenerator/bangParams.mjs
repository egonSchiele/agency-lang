...
__registerCallbacksInit("bangParams.agency", __registerTopLevelCallbacks);
...
let __functionCompleted = false;
  claimFrameForScope(__stack, "process", "bangParams.agency");
...
let __forked;
let __functionCompleted = false;
  claimFrameForScope(__stack, "main", "bangParams.agency");
