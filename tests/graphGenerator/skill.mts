...
graph.node("analyzeData", async (state): Promise<any> => {
...
async function _result(input: string, __metadata?: Record<string, any>): Promise<string> {
...
export async function analyzeData(input, { messages, callbacks } = {}): Promise<__State<any>> {
