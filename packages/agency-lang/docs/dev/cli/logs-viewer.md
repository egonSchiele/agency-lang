...
directories) is a separate app that embeds this viewer — see `docs/dev/cli/runs-explorer.md`.
...
`agency logs <dir>` on a run directory (`docs/dev/evals/run-directory.md`) opens
