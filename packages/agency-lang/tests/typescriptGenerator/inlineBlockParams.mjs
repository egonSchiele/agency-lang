...
__registerCallbacksInit("inlineBlockParams.agency", __registerTopLevelCallbacks);
...
let __functionCompleted = false;
  claimFrameForScope(__stack, "mapItems", "inlineBlockParams.agency");
...
// https://ampcode.com/threads/T-019e7a3a-edfa-74d6-917a-255c31bf8491.
{
  ...
  __log.error("Function " + "mapItems" + " threw an exception (converted to Failure): " + __errMsg);
...
let __forked;
let __functionCompleted = false;
  claimFrameForScope(__stack, "main", "inlineBlockParams.agency");
...
__stack.locals.doubled = await __call(mapItems, {
          ...
          namedArgs: {},
          blockArg: __AgencyFunction.create({ name: "__block_0", module: "inlineBlockParams.agency", fn: async (x: any) => {
...
claimFrameForScope(__bstack, "__block_0", "inlineBlockParams.agency");
...
export const __sourceMap = {"inlineBlockParams.agency:mapItems":{"1":{"line":1,"col":2},"2":{"line":2,"col":2},"3":{"line":6,"col":2},"2.0":{"line":3,"col":4},"2.1":{"line":4,"col":4}},"inlineBlockParams.agency:main":{"1":{"line":10,"col":2},"2":{"line":11,"col":2},"3":{"line":12,"col":2}},"inlineBlockParams.agency:__block_0":{}};