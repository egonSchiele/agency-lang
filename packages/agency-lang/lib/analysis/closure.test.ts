...
describe("agentClosure", () => {
  function closureProject(): string {
    ...
    fs.writeFileSync(
      path.join(projectDir, "lib", "helper.agency"),
      'export def helper(): string { return "hi" }\n',
    );
    fs.writeFileSync(
      path.join(projectDir, "agent.agency"),
