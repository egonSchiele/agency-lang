...
if (__ctx.stateStack.currentNodeId()) {
  __resultCheckpointId = __ctx.checkpoints.createPinned(__ctx, { moduleId: "namedArgs.agency", scopeName: "greet", stepPath: "", label: "result-entry" });
}
...
export const __sourceMap = {"namedArgs.agency:greet":{"0":{"line":-2,"col":2}}};