...
__registerCallbacksInit("sourceMap.agency", __registerTopLevelCallbacks);
...
let __functionCompleted = false;
  claimFrameForScope(__stack, "greet", "sourceMap.agency");
...
let __forked;
let __functionCompleted = false;
  claimFrameForScope(__stack, "main", "sourceMap.agency");
