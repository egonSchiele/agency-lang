...
let __functionCompleted = false;
  const runner = new Runner(__ctx, __stack, { nodeContext: true, state: __stack, moduleId: "static.agency", scopeName: "main", stack: __stateStack, threads: __threads });
  try {
...
export const __sourceMap = {"static.agency:main":{"1":{"line":2,"col":2}}};