...
let __functionCompleted = false;
  ...
  const runner = new Runner(__ctx, __stack, { state: __stack, moduleId: "sourceMap.agency", scopeName: "greet", stack: __stateStack, threads: __threads });
...
let __forked;
let __functionCompleted = false;
  const runner = new Runner(__ctx, __stack, { nodeContext: true, state: __stack, moduleId: "sourceMap.agency", scopeName: "main", stack: __stateStack, threads: __threads });
  try {
    await runner.hook(0, async () => {
await callHook({
        ctx: __ctx,
...
export const __sourceMap = {"sourceMap.agency:greet":{"1":{"line":1,"col":2},"2":{"line":2,"col":2}},"sourceMap.agency:main":{"1":{"line":6,"col":2},"2":{"line":7,"col":2},"3":{"line":12,"col":2},"2.0":{"line":8,"col":4},"2.1":{"line":10,"col":4},"3.0":{"line":13,"col":4}}};