/**
 * Memoizes one run directory per (workspaceKey, inputId). A nested store avoids any
...
export class EvalCache {
  private readonly runs: Record<string, Record<string, Promise<string>>> = Object.create(null);

  get(workspaceKey: string, inputId: string, produce: () => Promise<string>): Promise<string> {
