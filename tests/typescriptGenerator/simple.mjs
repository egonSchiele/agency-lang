...
if (__ctx.callbacks.onCheckpoint) {
  if (__ctx._skipNextCheckpoint) {
    ...
    const __cpId = __ctx.checkpoints.create(__ctx, { moduleId: "simple.agency", scopeName: "main", stepPath: "1" });
...
export const __sourceMap = {"simple.agency:main":{"0":{"line":-1,"col":2},"2":{"line":0,"col":2}}};