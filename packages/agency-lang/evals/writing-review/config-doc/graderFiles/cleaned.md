...
If `refuseSplices` is set, a file containing splices will fail to compile. This is a safety measure for codebases that want to avoid the risk of executing arbitrary code at compile time. It is off by default.
