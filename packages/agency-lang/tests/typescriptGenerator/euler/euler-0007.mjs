...
__registerCallbacksInit("euler-0007.agency", __registerTopLevelCallbacks);
...
let __functionCompleted = false;
  claimFrameForScope(__stack, "isPrime", "euler-0007.agency");
...
if (__error instanceof AgencyAbort) {
  ...
  return AbortedResult.fromError(__error, __stack, "isPrime");
}
...
// https://ampcode.com/threads/T-019e7a3a-edfa-74d6-917a-255c31bf8491.
{
  ...
  __log.error("Function " + "isPrime" + " threw an exception (converted to Failure): " + __errMsg);
...
let __forked;
let __functionCompleted = false;
  claimFrameForScope(__stack, "main", "euler-0007.agency");
