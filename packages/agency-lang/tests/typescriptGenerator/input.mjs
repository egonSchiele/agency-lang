...
__registerCallbacksInit("input.agency", __registerTopLevelCallbacks);
...
let __functionCompleted = false;
  claimFrameForScope(__stack, "main", "input.agency");
...
if (isAborted(__stack.locals.message)) {
          throw __stack.locals.message.toError()
        }
      });
...
export const __sourceMap = {"input.agency:main":{"1":{"line":1,"col":2},"2":{"line":3,"col":2},"3":{"line":4,"col":2}}};