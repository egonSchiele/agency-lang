...
if ((isInterrupt(__stack.locals.res1) || hasInterrupts(__stack.locals.res1))) {
...
// halt if this is an interrupt
if ((isInterrupt(__stack.locals.res2) || hasInterrupts(__stack.locals.res2))) {
            await __ctx.pendingPromises.awaitAll()
...
// halt if this is an interrupt
if ((isInterrupt(__stack.locals.res3) || hasInterrupts(__stack.locals.res3))) {
              await __ctx.pendingPromises.awaitAll()
...
// halt if this is an interrupt
if ((isInterrupt(__stack.locals.res5) || hasInterrupts(__stack.locals.res5))) {
              await __ctx.pendingPromises.awaitAll()
...
// halt if this is an interrupt
if ((isInterrupt(__stack.locals.res4) || hasInterrupts(__stack.locals.res4))) {
            await __ctx.pendingPromises.awaitAll()
