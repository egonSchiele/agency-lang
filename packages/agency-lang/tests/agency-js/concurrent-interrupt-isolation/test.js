import { foo, isInterrupt, approveInterrupt } from "./agent.js";
...
if (!isInterrupt(result1.data))
  throw new Error("Expected interrupt from call 1");
if (!isInterrupt(result2.data))
...
const [final1, final2] = await Promise.all([
  approveInterrupt(result1.data),
  approveInterrupt(result2.data),
]);
