...
let __functionCompleted = false;
  const runner = new Runner(__ctx, __stack, { nodeContext: true, state: __stack, moduleId: "setLLMClient.agency", scopeName: "main", stack: __stateStack, threads: __threads });
  try {
...
export const __sourceMap = {"setLLMClient.agency:main":{"1":{"line":6,"col":2},"2":{"line":7,"col":2}}};