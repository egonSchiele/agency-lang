...
if ((isInterrupt(__stack.locals.numbers) || hasInterrupts(__stack.locals.numbers))) {
...
// halt if this is an interrupt
if ((isInterrupt(__stack.locals.greetings) || hasInterrupts(__stack.locals.greetings))) {
        await __ctx.pendingPromises.awaitAll()
        runner.halt({
          messages: __threads,
