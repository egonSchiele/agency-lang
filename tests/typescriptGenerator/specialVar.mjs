...
if (isInterrupt(__stack.locals.response1)) {
  ...
  if (__ctx._skipNextCheckpoint) {
    ...
    const __cpId = __ctx.checkpoints.create(__ctx, { moduleId: "specialVar.agency", scopeName: "main", stepPath: "4" });
...
if (isInterrupt(__stack.locals.response2)) {
  ...
  if (__ctx._skipNextCheckpoint) {
    ...
    const __cpId = __ctx.checkpoints.create(__ctx, { moduleId: "specialVar.agency", scopeName: "main", stepPath: "8" });
    const __cp = __ctx.checkpoints.get(__cpId);
    await callHook({
      callbacks: __ctx.callbacks,
      name: "onCheckpoint",
