...
async function __initializeGlobals(__ctx) {
  if (__ctx.globals.isInitialized("castChecked.agency")) {
    return;
  }
  __ctx.globals.markInitialized("castChecked.agency")
}
__registerGlobalsInit("castChecked.agency", __initializeGlobals);
async function __registerTopLevelCallbacks(__ctx) {

}
__registerCallbacksInit("castChecked.agency", __registerTopLevelCallbacks);
...
let __functionCompleted = false;
  claimFrameForScope(__stack, "main", "castChecked.agency");
  const runner = new Runner(__ctx, __stack, { nodeContext: true, state: __stack, moduleId: "castChecked.agency", scopeName: "main", threads: __setupData.threads });
  try {
...
__stack.locals.p = __validateType(__stack.locals.raw, Person);
      });
...
export const __sourceMap = {"castChecked.agency:main":{"1":{"line":3,"col":2},"2":{"line":4,"col":2},"3":{"line":5,"col":2}}};