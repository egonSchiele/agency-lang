...
if ((isInterrupt(__stack.locals.mood) || hasInterrupts(__stack.locals.mood))) {
...
export const __sourceMap = {"rewindCheckpoint.agency:main":{"0":{"line":-1,"col":2},"1":{"line":0,"col":2}}};