...
let __functionCompleted = false;
  const runner = new Runner(__ctx, __stack, { nodeContext: true, state: __stack, moduleId: "rewindCheckpoint.agency", scopeName: "main", stack: __stateStack, threads: __threads });
  if (!__state.isResume) {
...
export async function main(message: string, { messages, callbacks }: { messages?: any; callbacks?: any } = {}): Promise<RunNodeResult<any>> {
  return runNode({
    ctx: __globalCtx,
    nodeName: "main",
    data: {
...
export const __sourceMap = {"rewindCheckpoint.agency:main":{"1":{"line":1,"col":2},"2":{"line":2,"col":2}}};