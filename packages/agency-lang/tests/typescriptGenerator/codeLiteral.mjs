...
async function __initializeGlobals(__ctx) {
  if (__ctx.globals.isInitialized("codeLiteral.agency")) {
    return;
  }
  __ctx.globals.markInitialized("codeLiteral.agency")
}
__registerGlobalsInit("codeLiteral.agency", __initializeGlobals);
async function __registerTopLevelCallbacks(__ctx) {

}
__registerCallbacksInit("codeLiteral.agency", __registerTopLevelCallbacks);
...
let __functionCompleted = false;
  claimFrameForScope(__stack, "main", "codeLiteral.agency");
  const runner = new Runner(__ctx, __stack, { nodeContext: true, state: __stack, moduleId: "codeLiteral.agency", scopeName: "main", threads: __setupData.threads });
  try {
...
__stack.locals.exprKind = __codeLiteral("1 + 2", "expr");
      });
      await runner.step(2, async (runner) => {
__stack.locals.stmtsKind = __codeLiteral("const a = 1\nprint(a)", "statements");
      });
      await runner.step(3, async (runner) => {
__stack.locals.programKind = __codeLiteral("def g(n: number): number {\n  return n * 2\n}", "program");
      });
      await runner.step(4, async (runner) => {
__stack.locals.holed = __codeLiteral("const x: number = #count\n#steps", "statements");
      });
      await runner.step(5, async (runner) => {
const __funcResult = await __call(print, {
          type: "positional",
          args: [__stack.locals.exprKind]
        });
...
const __funcResult = await __call(print, {
          type: "positional",
          args: [__stack.locals.programKind]
        });
if (hasInterrupts(__funcResult)) {
          await getRuntimeContext().ctx.pendingPromises.awaitAll()
          runner.halt({
...
export const __sourceMap = {"codeLiteral.agency:main":{"1":{"line":1,"col":2},"2":{"line":2,"col":2},"3":{"line":6,"col":2},"4":{"line":11,"col":2},"5":{"line":15,"col":2},"6":{"line":16,"col":2},"7":{"line":17,"col":2},"8":{"line":18,"col":2}}};