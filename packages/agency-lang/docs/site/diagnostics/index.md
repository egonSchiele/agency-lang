...
| [AG8004](templates.md#ag8004) | The generator `&#123;name&#125;` reaches &#123;source&#125;, so it could produce different code on different builds. Compile-time generators must be deterministic. |
