...
async function __initializeGlobals(__ctx) {
  if (__ctx.globals.isInitialized("comprehension.agency")) {
    return;
  }
  __ctx.globals.markInitialized("comprehension.agency")
}
__registerGlobalsInit("comprehension.agency", __initializeGlobals);
async function __registerTopLevelCallbacks(__ctx) {

}
__registerCallbacksInit("comprehension.agency", __registerTopLevelCallbacks);
...
__stack.locals.nums = [1, 2, 3, 4];
      });
      await runner.step(2, async (runner) => {
__stack.locals.doubled = await __call(map, {
          type: "named",
          positionalArgs: [__stack.locals.nums],
          namedArgs: {},
          blockArg: __AgencyFunction.create({ name: "__block_0", module: "comprehension.agency", fn: async (n: any) => {
...
const runner = new Runner(__ctx, __bstack, { state: __bstack, moduleId: "comprehension.agency", scopeName: "__block_0" });
try {
await runner.step(0, async (runner) => {
runner.halt(__bstack.args.n * 2)
return;
  });
...
__bsetup.stateStack.pop();
          ...
          }, params: [{ name: "n", hasDefault: false, defaultValue: undefined, variadic: false }], toolDefinition: null }, __toolRegistry)
        });
...
__stack.locals.__hoist_0 = await __call(filter, {
          type: "named",
          positionalArgs: [__stack.locals.nums],
          namedArgs: {},
          blockArg: __AgencyFunction.create({ name: "__block_1", module: "comprehension.agency", fn: async (n: any) => {
            const __bsetup = setupFunction();
const __bstack = __bsetup.stack;
const __self = __bstack.locals;
...
const runner = new Runner(__ctx, __bstack, { state: __bstack, moduleId: "comprehension.agency", scopeName: "__block_1" });
try {
await runner.step(0, async (runner) => {
runner.halt(__eq(__bstack.args.n % 2, 0))
return;
  });
return runner.halted ? runner.haltResult : undefined;
} catch (__blockError) {
...
__stack.locals.evens = await __call(map, {
          type: "named",
          positionalArgs: [__stack.locals.__hoist_0],
          namedArgs: {},
          blockArg: __AgencyFunction.create({ name: "__block_2", module: "comprehension.agency", fn: async (n: any) => {
            const __bsetup = setupFunction();
const __bstack = __bsetup.stack;
const __self = __bstack.locals;
...
const runner = new Runner(__ctx, __bstack, { state: __bstack, moduleId: "comprehension.agency", scopeName: "__block_2" });
try {
await runner.step(0, async (runner) => {
runner.halt(__bstack.args.n)
return;
  });
return runner.halted ? runner.haltResult : undefined;
} catch (__blockError) {
...
if (hasInterrupts(__stack.locals.evens)) {
          await getRuntimeContext().ctx.pendingPromises.awaitAll()
          runner.halt({
            ...__state,
            data: __stack.locals.evens
          })
          return;
        }
if (isAborted(__stack.locals.evens)) {
          throw __stack.locals.evens.toError()
        }
      });
...
export const __sourceMap = {"comprehension.agency:main":{"1":{"line":1,"col":2},"2":{"line":2,"col":2},"3":{"line":3,"col":16},"4":{"line":3,"col":2},"5":{"line":4,"col":2},"6":{"line":5,"col":2}},"comprehension.agency:__block_0":{"2.0":{"line":2,"col":18}},"comprehension.agency:__block_1":{"3.0":{"line":3,"col":16}},"comprehension.agency:__block_2":{"4.0":{"line":3,"col":16}}};