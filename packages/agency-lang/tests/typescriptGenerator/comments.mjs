...
__registerCallbacksInit("comments.agency", __registerTopLevelCallbacks);
...
let __functionCompleted = false;
  claimFrameForScope(__stack, "greet", "comments.agency");
...
let __forked;
let __functionCompleted = false;
  claimFrameForScope(__stack, "main", "comments.agency");
