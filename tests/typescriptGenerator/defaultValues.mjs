...
export async function greet(name: string, greeting: string | null = null, __state: InternalFunctionState | undefined = undefined) {
...
export const __sourceMap = {"defaultValues.agency:greet":{"1":{"line":-1,"col":2}}};