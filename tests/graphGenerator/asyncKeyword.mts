...
export const __openaiToolParams = ["msg"];export const __googleTool = {
  name: "google",
  description: `No description provided.`,
  schema: z.object({"msg": z.string(), })
};

export const __googleToolParams = ["msg"];export const __fibsTool = {
  name: "fibs",
  description: `No description provided.`,
  schema: z.object({})
};
...
async function _response(msg: string, __metadata?: Record<string, any>): Promise<string> {
...
async function ___promptVar(__metadata?: Record<string, any>): Promise<number[]> {
  ...
  return result.response;
    ...
    return responseMessage.output;
    // console.error("Error parsing response for variable '__promptVar':", e);
...
if (isInterrupt(__stack.locals.msg)) {
  ...
  return { ...state, data: __stack.locals.msg };
