...
[`docs/dev/runtime/concurrent-interrupts.md`](./concurrent-interrupts.md). This
...
frames convert aborts into return values — see `docs/dev/runtime/saveDraft.md`).
...
`docs/dev/runtime/concurrent-interrupts.md` for the longer rationale).
