...
let __functionCompleted = false;
  const runner = new Runner(__ctx, __stack, { nodeContext: true, state: __stack, moduleId: "objectDescription.agency", scopeName: "main", stack: __stateStack });
  try {
...
export const __sourceMap = {"objectDescription.agency:main":{"1":{"line":1,"col":2},"2":{"line":3,"col":2}}};