...
describe("generateTypeScript - TimeBlock support", () => {
  describe("Time blocks generate correct timing code", () => {
    it("should generate timing code for simple time block", () => {
      const program: AgencyProgram = {
        type: "agencyProgram",
        nodes: [
          {
      ...
      // Should start timing
      expect(result).toContain("const _timeBlockResult_duration_startTime = performance.now();");
      // Should include the body
      expect(result).toContain("const x = 1;");
      // Should end timing
      expect(result).toContain("const _timeBlockResult_duration_endTime = performance.now();");
      // Should calculate duration
      expect(result).toContain("const _timeBlockResult_duration = _timeBlockResult_duration_endTime - _timeBlockResult_duration_startTime;");
    });

    it("should generate timing code for time block with multiple statements", () => {
      const program: AgencyProgram = {
        type: "agencyProgram",
        nodes: [
          {
      ...
      expect(result).toContain("const _timeBlockResult_elapsed_startTime = performance.now();");
      expect(result).toContain("const a = 1;");
      expect(result).toContain("const b = 2;");
      expect(result).toContain("const c = 3;");
      expect(result).toContain("const _timeBlockResult_elapsed_endTime = performance.now();");
      expect(result).toContain("const _timeBlockResult_elapsed = _timeBlockResult_elapsed_endTime - _timeBlockResult_elapsed_startTime;");
    });

    it("should generate timing code for time block with prompt", () => {
      const program: AgencyProgram = {
        type: "agencyProgram",
        nodes: [
          {
      ...
      expect(result).toContain("const _timeBlockResult_timing_startTime = performance.now();");
      expect(result).toContain("say hello");
      expect(result).toContain("const _timeBlockResult_timing_endTime = performance.now();");
      expect(result).toContain("const _timeBlockResult_timing = _timeBlockResult_timing_endTime - _timeBlockResult_timing_startTime;");
    });

    it("should generate timing code for time block with function call", () => {
      const program: AgencyProgram = {
        type: "agencyProgram",
        nodes: [
          {
            type: "assignment",
            variableName: "funcTiming",
            value: {
              type: "timeBlock",
              body: [
                {
      ...
      expect(result).toContain("const _timeBlockResult_funcTiming_startTime = performance.now();");
      expect(result).toContain("const result = await doSomething();");
      expect(result).toContain("const _timeBlockResult_funcTiming_endTime = performance.now();");
      expect(result).toContain("const _timeBlockResult_funcTiming = _timeBlockResult_funcTiming_endTime - _timeBlockResult_funcTiming_startTime;");
    });

    it("should generate timing code for empty time block", () => {
      const program: AgencyProgram = {
        type: "agencyProgram",
        nodes: [
          {
            type: "assignment",
            variableName: "emptyTiming",
            value: {
              type: "timeBlock",
              body: [],
            },
      ...
      expect(result).toContain("const _timeBlockResult_emptyTiming_startTime = performance.now();");
      expect(result).toContain("const _timeBlockResult_emptyTiming_endTime = performance.now();");
      expect(result).toContain("const _timeBlockResult_emptyTiming = _timeBlockResult_emptyTiming_endTime - _timeBlockResult_emptyTiming_startTime;");
    });

    it("should use unique timing variable names for different variables", () => {
      const program: AgencyProgram = {
        type: "agencyProgram",
        nodes: [
          {
      ...
      expect(result).toContain("const _timeBlockResult_time1_startTime = performance.now();");
      expect(result).toContain("const _timeBlockResult_time1_endTime = performance.now();");
      expect(result).toContain("const _timeBlockResult_time1 = _timeBlockResult_time1_endTime - _timeBlockResult_time1_startTime;");

      expect(result).toContain("const _timeBlockResult_time2_startTime = performance.now();");
      expect(result).toContain("const _timeBlockResult_time2_endTime = performance.now();");
      expect(result).toContain("const _timeBlockResult_time2 = _timeBlockResult_time2_endTime - _timeBlockResult_time2_startTime;");
    });
  });
});
