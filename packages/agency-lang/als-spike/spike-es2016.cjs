...
// ../../../node_modules/.pnpm/zone.js@0.16.2/node_modules/zone.js/fesm2015/zone-node.js
...
var AsyncLocalStorage = class {
  ...
  run(store, callback, ...args) {
    ...
    return zone.run(callback, void 0, args);
  }
...
function branch(expectedId, delayMs) {
  return __async(this, null, function* () {
    var _a, _b;
    const before = (_a = als.getStore()) == null ? void 0 : _a.id;
    yield sleep(delayMs);
    yield Promise.resolve();
    const after = (_b = als.getStore()) == null ? void 0 : _b.id;
...
function main() {
  return __async(this, null, function* () {
    ...
    const [ra, rb] = yield Promise.all([pA, pB]);
    const nested = yield als.run({ id: "outer" }, () => __async(null, null, function* () {
      var _a, _b;
      const outerBefore = (_a = als.getStore()) == null ? void 0 : _a.id;
      const inner = yield als.run({ id: "inner" }, () => __async(null, null, function* () {
        var _a2;
        yield sleep(10);
        return (_a2 = als.getStore()) == null ? void 0 : _a2.id;
      }));
      yield sleep(10);
      const outerAfter = (_b = als.getStore()) == null ? void 0 : _b.id;
