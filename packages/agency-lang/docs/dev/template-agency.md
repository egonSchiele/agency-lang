...
**Known limit:** destructuring-pattern binders are not tracked. A filler that destructures into a name the template uses is a missed collision; the guide documents it.
