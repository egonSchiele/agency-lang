...
let __functionCompleted = false;
  const runner = new Runner(__ctx, __stack, { nodeContext: true, state: __stack, moduleId: "noResponseFormat.agency", scopeName: "main", stack: __stateStack, threads: __threads });
  try {
...
export const __sourceMap = {"noResponseFormat.agency:main":{"1":{"line":1,"col":2},"2":{"line":2,"col":2}}};